...
Gem::Specification.new do |spec|
  spec.name          = "portfolio-blog-theme"
    spec.version       = "0.1"
    spec.authors       = ["sufi_malek"]
    spec.email         = ["sufiyanmalek78@gmail.com"]

    spec.summary       = "Clean and simple Jekyll theme built using Bulma"
    spec.homepage      = "https://www.github.com/sufimalek/portfolio-blog-theme"
  spec.license       = "MIT"
